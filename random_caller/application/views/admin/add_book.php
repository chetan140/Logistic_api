  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add book Image</h5>
...
echo base_url('admin/insert_book_image');
?>">

    <div class="form-group">
      <label for="exampleInputEmail1">Select The book Image</label>
      <input type="file" name="image" required>
    </div>


    <div class="form-group">
      <label for="exampleInputEmail1">Select The book PDF</label>
...
$(document).on('click', '.delete', function(){ 
        var id = $(this).attr("id");  
            ...
            .then((willDelete) => {
              if (willDelete) {
              window.location.href='admin/delete_book_image?id='+id;
              }
            })        
