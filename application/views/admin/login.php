            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Sign In to Logistic Admin</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                ...
                <?php endif; ?>
                            <form class="form-horizontal m-t-20" method="post" id="loginform" action="<?= base_url("Admin/login_controller") ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <a href="<?= base_url("Admin/forgetpassword"); ?>"  class="text-dark float-right"><i class="fa fa-lock m-r-5"></i> Forgot password?</a>
                                        </div>
                                    </div>
                                </div>
