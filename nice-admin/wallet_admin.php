            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Wallet Admin</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Basic Wallet Admin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Tokyo</td>
                                                <td>Tokyo</td>
                                                <td><button class="btn btn-md btn-outline-success" > Edit</button></td>
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/nice-admin/html/ltr/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Sep 2018 05:09:02 GMT -->
</html>