...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalLabel">Add online_service Image</h5>
    ...
    <div class="modal-body">
      <form method="POST" enctype="multipart/form-data" action="<?php
        echo base_url('admin/insert_online_service_image');
        ?>">
       
        
          <div class="form-group">
      <label for="exampleInputEmail1">Select The Slider Image</label><br>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="Enter Your Head" name="head" required>
         ...
         <div class="form-group">
          <label for="exampleInputEmail1">Enter Onlive Service Url</label>
...
.then((willDelete) => {
if (willDelete) {
window.location.href='admin/delete_online_service_image?id='+id;
}
})
