                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header"><br><br>
                            <h2>Add home_course  </h2> 
<br>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  Add home_course Images
</button>                           
                        </div>
                        <div class="body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add home_course Image</h5>
...
echo base_url('admin/insert_home_course_image');
?>">

    <div class="form-group">
      <label for="exampleInputEmail1">Select The home_course Image</label>
...
$(document).on('click', '.delete', function(){ 
        var id = $(this).attr("id");  
            ...
            .then((willDelete) => {
              if (willDelete) {
              window.location.href='admin/delete_home_course_image?id='+id;
              }
            })        
