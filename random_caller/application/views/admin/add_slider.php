...
foreach ($data as $row) {
    ...
    echo "<td><center><img style='width: 100px;height: 70px;' src= ".base_url().'newimage/'.$row->slider_image."></center></td>";
      echo "<td>" . $row->head . "</td>";
...
?>">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label for="exampleInputEmail1">Enter Head (Optional)</label>
      <input type="text" class="form-control" placeholder="Enter Your Head" name="head" >
    </div>

    
      <div class="form-group">
      <label for="exampleInputEmail1">Enter Content (Optional) </label>
      <input type="text" placeholder="Enter Your Content" class="form-control" name="content" >
    </div><br>
